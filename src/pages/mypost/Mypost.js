    ...
    useEffect(() => {
        const handlefetchPosts = async () => {
            try {
                ...
                const url = active === 3
                    ? `${process.env.REACT_APP_SERVER_IP}/mypage/${memberId}/posting`
                    : active === 4
                        ? `${process.env.REACT_APP_SERVER_IP}/mypage/${memberId}/vote`
                        : `${process.env.REACT_APP_SERVER_IP}/mypage/${memberId}/liked`; //active 5
